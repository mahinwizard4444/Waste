...
async def next_page(bot, query):
    ...
    btn.insert(0, 
        [
            InlineKeyboardButton('🎬 Join 🎬', url='https://t.me/M76Links')
        ]
    )
